      ...
      <div className={styles.dashboardContainer}>
        ...
        <div className={styles.card}>
          <div>
            ...
            <p className={styles.cardValue}>{totalTestCases}</p>
          </div>
              ...
              projects.map((p, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <div className={styles.projectPrimaryActionRow}>
                      <button
                      ...
                      >
                        <i className="fa-solid fa-play"></i> Open
                                            ...
                                            <button
                        className={styles.actionButton}
                        onClick={() => onImageUpdate && onImageUpdate(p)}
                      >
                        <i className="fa-regular fa-image"></i> Image Update
                      </button>
                    </div>
