...
def verify_sure_here_are_the_extracted_ui_elements_visible(page):
    assert page.smartAI('contact_sure,_here_are_the_extracted_ui_elements_-_label_sure_here_are_the_extracted_ui_elements_info_c6761d34').is_visible()

def verify_dynamics_365_visible(page):
    assert page.smartAI('contact_dynamics_365_label_dynamics_365_info_fcc62dae').is_visible()

def verify_customer_service_visible(page):
    assert page.smartAI('contact_customer_service_label_customer_service_info_8c6d35ee').is_visible()
...
def click_edit_columns(page):
    page.smartAI('contact_edit_columns_button_edit_columns_action_81e353c8').click()

def click_edit_filters(page):
    page.smartAI('contact_edit_filters_button_edit_filters_action_703f2fb9').click()
...
def click_share(page):
    page.smartAI('contact_share_button_share_action_35cbb267').click()
