...
def enter_customers(page, value):
...
def assert_enter_loans(page, expected: str, timeout: int = 6000):
    exp = str(expected)
...
def assert_enter_customers(page, expected: str, timeout: int = 6000):
    exp = str(expected)
    # 1) Prefer SmartAI target
    try:
