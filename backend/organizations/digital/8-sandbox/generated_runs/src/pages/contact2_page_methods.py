...
def verify_dynamics_365_visible(page):
    assert page.smartAI('contact2_dynamics_365_label_dynamics_365_info_b157cd0b').is_visible()

def verify_customer_service_visible(page):
    assert page.smartAI('contact2_customer_service_label_customer_service_info_2bd89ad7').is_visible()
