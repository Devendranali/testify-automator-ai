...
def verify_dynamics_365_visible(page):
    assert page.smartAI('contact1_dynamics_365_label_dynamics_365_info_f74c4fa2').is_visible()

def verify_customer_service_visible(page):
    assert page.smartAI('contact1_customer_service_label_customer_service_info_23909f13').is_visible()
...
def select_contact(page, value):
    page.smartAI('contact1_contact_select_contact_select_8de2a59b').select_option(value)
...
def assert_select_contact(page, expected: str, timeout: int = 6000):
    ...
    # 1) Native <select>: check value and selected label
    try:
        el = page.smartAI('contact1_contact_select_contact_select_8de2a59b')
        try:
            expect(el).to_have_value(exp, timeout=timeout)
            return
        except Exception:
    ...
    try:
        ...
        pass
    # Final failure
    raise AssertionError(f"Assertion failed for select '{lbl or 'contact1_contact_select_contact_select_8de2a59b'}' expecting '{exp}'.")
