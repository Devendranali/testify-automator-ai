...
def verify_dashboard_visible(page):
    assert page.smartAI('bank_dashboard_dashboard_label_dashboard_info_8fe4a740').is_visible()

def verify_customers_visible(page):
    assert page.smartAI('bank_dashboard_customers_label_customers_info_b6f8db6c').is_visible()

def verify_loans_visible(page):
    assert page.smartAI('bank_dashboard_loans_label_loans_info_bc465b33').is_visible()

def verify_transactions_visible(page):
    assert page.smartAI('bank_dashboard_transactions_label_transactions_info_55a2b41f').is_visible()

def verify_tasks_visible(page):
    assert page.smartAI('bank_dashboard_tasks_label_tasks_info_411a0f4d').is_visible()

def verify_reports_visible(page):
    assert page.smartAI('bank_dashboard_reports_label_reports_info_2195e0e3').is_visible()

def verify_analytics_visible(page):
    assert page.smartAI('bank_dashboard_analytics_label_analytics_info_211b07e0').is_visible()

def verify_settings_visible(page):
    assert page.smartAI('bank_dashboard_settings_label_settings_info_e9592945').is_visible()
...
def verify_john_doe_visible(page):
    assert page.smartAI('bank_dashboard_john_doe_label_john_doe_info_7ba10d71').is_visible()
