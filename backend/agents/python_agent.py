...
#             f"        print(f'[SmartAI][select_option fallback] Native select_option failed: {{e}}')\n"
#             f"        try:\n"
#             f"            try:\n"
#             f"                page.get_by_role('combobox').click()\n"
#             f"            except Exception:\n"
#             f"                page.get_by_role('listbox').click()\n"
#             f"            page.get_by_role('option', name=value).click()\n"
#             f"            print(f'[SmartAI][select_option fallback] Selected {{value}} via combobox/listbox+option fallback')\n"
#             f"        except Exception as e2:\n"
#             f"            print(f'[SmartAI][select_option fallback] Fallback also failed: {{e2}}')\n"
#             f"            raise\n"
#         )
#     elif ocr_type == "multiselect":
#         func_name = f"select_{func('multiselect')}_values"
